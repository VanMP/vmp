  ...
  return (
    <section className="px-6 py-2 md:px-8 md:py-4 w-full font-sans">
      <div className="relative border border-border-soft bg-surface/40 p-6 md:p-8 rounded-2xl grid grid-cols-1 md:grid-cols-[1fr_1.3fr] gap-8 md:gap-10 md:h-[500px] lg:h-[460px] shadow-[0_2px_12px_rgba(44,40,34,0.015)] overflow-hidden">
        ...
        <div className="flex flex-col gap-4 justify-between h-full overflow-y-auto pr-1.5 relative z-10">
          <div className="space-y-3">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold text-wine tracking-tight font-serif mt-1">
                Vanessa Martins Pinto
              </h1>
              <p className="text-xs md:text-sm font-semibold text-olive italic mt-1 font-serif">
                {lang === "pt"
        ...
        <div className="flex flex-col justify-start gap-3 h-full overflow-y-auto pr-1 relative z-10">
          <div className="flex items-center gap-2">
            ...
            {educationItems.map((item, idx) => {
              ...
              return (
                <div 
                  ...
                  className={`p-2.5 bg-frost/50 border rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.01)] hover:border-wine/25 transition-soft cursor-pointer select-none ${
                ...
                >
                  <div className="flex justify-between items-start gap-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                        <h4 className="text-xs md:text-sm font-bold text-txt-main">
                          {lang === "pt" ? item.titlePt : item.titleEn}
                        </h4>
                        <span className="text-[9px] md:text-[10px] font-bold font-mono text-txt-muted uppercase px-2 py-0.5 bg-surface border border-border-soft/40 rounded flex-shrink-0 self-start sm:self-auto">
                          {lang === "pt" ? item.periodPt : item.periodEn}
                        </span>
                      </div>
                      <span className="text-[10px] md:text-xs text-olive font-semibold font-serif block mt-0.5">
                        {item.institution}
                      </span>
                    </div>
                  ...
                  >
                    <p className="text-[10px] md:text-xs text-txt-muted leading-relaxed">
