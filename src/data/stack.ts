...
export const stackItems: StackItem[] = [
  ...
  { name: "Statsmodels", category: "Análise", categoryEn: "Analysis", note: "Biblioteca para modelagem econométrica rigorosa, regressões GLM/Logit, testes de hipóteses e diagnósticos de colinearidade.", noteEn: "Library for rigorous econometric modeling, GLM/Logit regressions, hypothesis testing, and collinearity diagnostics." },
  { name: "SciPy", category: "Análise", categoryEn: "Analysis", note: "Computação científica, otimização não-linear multivariada (L-BFGS-B) e distribuições de probabilidade estatísticas.", noteEn: "Scientific computing, multivariate non-linear optimization (L-BFGS-B), and statistical probability distributions." },
